        ...
        <div class="container">
            <div class="job-header">
                ...
                <div class="company-info">
                    <h2>Company: <span class="company-name">Oracle</span></h2>
                    <p>Location: <span class="location">Austin,Texas, USA</span></p>
                    <p>Posted on: <span class="post-date">JAN 7, 2025</span></p>
                </div>
            </div>
            ...
            <div class="job-description">
                ...
                <ul>
                    ...
                    <li>Proficiency in Java, Python, C or C++.</li>
            ...
            <div class="job-application">
                ...
                <p>Salary Range: 7.02Lakh to 1.15Cr per year</p>
            ...
            <div class="contact-info">
                ...
                <p>Contact HR: <a href="mailto:hr@Oracle.com">hr@Oracle.com</a></p>
            </div>
        </div>
    </section>
