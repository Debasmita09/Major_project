  ...
  <body>
    ...
    <div class="main-content">
      ...
      <div class="middle">
        ...
        <hr class="customHr">
        <div
  class="bg-white p-4 rounded-lg shadow-md border border-gray-300 flex items-center"
>
  <img
    src="{{url('image/jobCard1.jpg')}}"
    alt="Job Image"
  ...
  <div class="flex-1 ml-4">
    ...
    <p class="text-sm text-gray-600 mt-1">
      Join our team. We help shape your future.
    </p>
    <p class="text-sm text-gray-600 mt-1 flex items-center">
      <i class="fa-solid fa-location-dot text-gray-600 mr-1"></i> Noida 
      <span class="mx-2">|</span> 
      <i class="fa-solid fa-indian-rupee-sign text-gray-600 mr-1"></i> 4 LPA
    </p>
    <div class="flex items-center justify-between mt-2">
      <div class="text-yellow-500 text-sm">⭐⭐⭐⭐☆ (4.0)</div>
      <span class="mx-2">|</span> 
      <p class="text-gray-600 mr-1">28700 reviews</p>
      <button
        class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700"><a href="{{url('/SofDev')}}"> View/Apply </a></button>
    </div>
</div>
        ...
        <div
          class="bg-white p-4 rounded-lg shadow-md border border-gray-300 flex items-center gap-4"
        >
          <img
            src="{{url('image/jobCard2.png')}}"
            alt="Job Image"
            class="w-32 h-32 object-cover rounded-md"
          />
          <div class="flex-1">
            <h3 class="text-lg font-semibold text-gray-800 flex items-center ">Mean Developer
            </h3>
            <p class="text-sm text-gray-600 mt-1">
              We grab your design and reach it whole world.
            </p>
            <p class="text-sm text-gray-600 mt-1 flex items-center">
              <i class="fa-solid fa-location-dot text-gray-600 mr-1"></i> Hyderabad 
              <span class="mx-2">|</span> 
              <i class="fa-solid fa-indian-rupee-sign text-gray-600 mr-1"></i> 7 LPA
            </p>
            <div class="flex items-center justify-between mt-2">
              <div class="text-yellow-500 text-sm">⭐⭐⭐⭐☆ (4.0)</div>
              <span class="mx-2">|</span> 
              <p class="text-gray-600 mr-1">25500 reviews</p>
              <button
        ...
        >
          <img
            src="{{url('image/jobCard3.jpg')}}"
            alt="Job Image"
            class="w-32 h-32 object-cover rounded-md"
          />
          <div class="flex-1">
            <h3 class="text-lg font-semibold text-gray-800 flex items-center">Accountant
            </h3>
            <p class="text-sm text-gray-600 mt-1">
              Join our expert team.You learn something.
            </p>
            <p class="text-sm text-gray-600 mt-1 flex items-center">
              <i class="fa-solid fa-location-dot text-gray-600 mr-1"></i> Kolkata
              <span class="mx-2">|</span> 
              <i class="fa-solid fa-indian-rupee-sign text-gray-600 mr-1"></i> 1.80 LPA
            </p>
            <div class="flex items-center justify-between mt-2">
              <div class="text-yellow-500 text-sm">⭐⭐⭐⭐☆ (4.0)</div>
              <span class="mx-2">|</span> 
              <p class="text-gray-600 mr-1">22500 reviews</p>
              <button class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700"><a href="{{url('/Accountant')}}">
                View/Apply</a>
              </button>
            </div>
          </div>
      ...
      <div class="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-6">
        <div>
          ...
          <div class="flex space-x-4 mt-3">
            <a href="twitter.com" class="text-white text-lg"
              ><i class="fab fa-twitter"></i
            ></a>
            <a href="facebook.com" class="text-white text-lg"
              ><i class="fab fa-facebook"></i
            ></a>
            <a href="instagram.com" class="text-white text-lg"
