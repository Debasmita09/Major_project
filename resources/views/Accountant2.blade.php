        ...
        <div class="container">
            <div class="job-header">
                ...
                <div class="company-info">
                    <h2>Company: <span class="company-name">KPMG</span></h2>
                    <p>Location: <span class="location">New Delhi,India</span></p>
                    <p>Posted on: <span class="post-date">FEB 5, 2025</span></p>
                </div>
            </div>
            ...
            <div class="job-application">
                ...
                <p>Salary Range: 19,568 - 25,214 per year</p>
                <p>Benefits: Health insurance, 457(k), Paid Time Off, Remote work option</p>
            ...
            <div class="contact-info">
                ...
                <p>Contact HR: <a href="mailto:hr@KPMG.com">hr@KPMG.com</a></p>
            </div>
        </div>
    </section>
