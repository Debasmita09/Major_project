        ...
        <div class="container">
            <div class="job-header">
                ...
                <div class="company-info">
                    <h2>Company: <span class="company-name">Mern Stack Developers</span></h2>
                    <p>Location: <span class="location">Bangalore, India</span></p>
                    <p>Posted on: <span class="post-date">Jan 4, 2025</span></p>
                </div>
            </div>
            ...
            <div class="job-application">
                ...
                <p>Salary Range: 45,524 - 90,654 per year</p>
                <p>Benefits: Health insurance, 521(k), Paid Time Off, Remote work option</p>
            ...
            <div class="contact-info">
                ...
                <p>Contact HR: <a href="mailto:hr@mernstackdevelopers.com">hr@mernstackdevelopers.com</a></p>
            </div>
        </div>
    </section>
